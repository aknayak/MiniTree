...
class MyEvent
{
 public:
  ...
  enum SampleType {DATA = 0, WH=1, HH=2, TTBAR=10, ZJETS=30, Z1JETS=61, Z2JETS=62, Z3JETS=63, Z4JETS=64, WJETS=40, W1JETS=41, W2JETS=42, W3JETS=43, W4JETS=44, TOPS=50, TOPT=51, TOPW=52, TBARS=53, TBART=54, TBARW=55, QCD=60, WW=70, WZ=71, ZZ=72, OTHER=80};
